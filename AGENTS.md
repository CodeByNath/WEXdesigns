...
- For Heading DNA navigation, start at the [Heading DNA Code Map](docs/code-map/heading-dna.md). It routes to the accepted, registered Page Heading DNA v1 decision.
