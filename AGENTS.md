...
- For Heading DNA navigation, start at the [Heading DNA Code Map](docs/code-map/heading-dna.md). The proposed Page Heading v1 decision is its normative candidate; it is not registered for use until accepted.
